...
export default function Testing({navigation}) {
  return (
    <ImageBackground resizeMode='cover' style={styles.home} source={require("../../assets/images/testing.png")}>
       <Navigationcomp navigation={navigation} back={"bas"}/>
          <View style={styles.parbtn}>
            <TouchableOpacity
            onPress={()=>navigation.navigate("scrum")}
            style={styles.btn}>
